...
@Testcontainers
@SpringBootTest
class AuthorizationOutboxIntegrationTest {
    ...
    @Test
    void successfulAuthorizationCreatesOutboxEvent() {
        ...
        assertEquals(
                payment.getId(),
                authorizedEvent.getAggregateId()
        );

        assertEquals(
                OutboxEventStatus.PENDING,
                authorizedEvent.getStatus()
        );

        assertNotNull(
                authorizedEvent.getPayload()
        );
    }
}